...
export function HeroOS() {
  ...
  const handleSearchClick = () => {
    trackEvent('hero_search_focus');
  };
  return (
    <section className="relative pt-8 pb-12 space-y-8">
      <div className="space-y-4 text-center md:text-left">
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-orange-500/10 text-orange-600 dark:text-orange-400 text-xs font-bold uppercase tracking-widest animate-fade-in">
        ...
        <h1 className="text-4xl md:text-6xl lg:text-7xl font-display font-black tracking-tight leading-[1.1]">
          Explore St. Louis <br />
          <span className="text-muted-foreground">The City OS</span>
        </h1>
      ...
      <div className="max-w-2xl relative group">
        <div className="absolute inset-0 bg-orange-500/20 blur-2xl rounded-3xl opacity-0 group-focus-within:opacity-100 transition-opacity" />
        <div className="relative flex items-center bg-secondary/40 backdrop-blur-xl border border-border/50 rounded-3xl p-1.5 shadow-2xl focus-within:ring-2 ring-orange-500/20 transition-all">
          ...
          />
          <Button className="rounded-2xl h-11 px-6 bg-orange-500 hover:bg-orange-600 font-bold gap-2 shadow-lg shadow-orange-500/20">
